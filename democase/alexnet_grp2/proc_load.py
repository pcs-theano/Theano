...
#def fun_load(config, sock_data=5000):
    ...
    while True:
        ...
        # for debug
        #"""
        #hkl.dump(data[:10, :, :, :], "test_bc01.hkl", mode="w")
        #data1 = hkl.load("../alexnet_org/test_data/img_c01b_" + str(cnt) +".hkl")
        
        #print data.shape, data1.shape
        #data2 = hkl.load("test_bc01.hkl")
        ...
        shared_x.set_value(data) #[2015-10-21]: support parallel load for CPU version
