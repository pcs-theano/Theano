...
class conv_forward(MKLConvBase):
    ...
    def grad(self, inp, grads):
        ...
        d_weights = conv_gradWeights(self.border_mode,
                                    self.subsample,
                                    imshp=self.imshp,
                                    kshp=self.kshp)(bottom, weights, top)
        return d_image, d_weights

class conv_forward_with_bias(MKLConvBase):
    def c_cleanup_code_struct(self, node, name):
...
class conv_gradWeights_with_bias(MKLConvBase):
    #def infer_shape(self, node, input_shape):
    #    if self.border_mode == "half":
    #        padH = padW = -1
    #    elif self.border_mode == "full":
...
class conv_gradInputs_with_bias(MKLConvBase):
    #def infer_shape(self, node, input_shape):
    #    if self.border_mode == "half":
    #        padH = padW = -1
    #    elif self.border_mode == "full":
